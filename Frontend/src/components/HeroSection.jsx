...
const HeroSection = () => {
  ...
  return (
    <section className="py-20 md:py-32 bg-gradient-to-br from-green-50 to-emerald-100">
      <div className="landingcontainer mx-auto max-w-7xl px-4 md:px-6 grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
        ...
        >
          ...
          <img
            src="/images/hero2.png" // Replace with actual image path
            alt="Hero Image"
            width="600"
            height="500"
