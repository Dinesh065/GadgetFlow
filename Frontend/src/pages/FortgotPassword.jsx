...
const ForgotPassword = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white to-emerald-100 flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-white shadow-md border border-gray-200 rounded-xl p-8">
        <h2 className="text-3xl font-bold text-green-600 text-center mb-6">Forgot Password</h2>
        ...
        {step === 1 && (
          <>
            ...
            <input
              type="email"
              placeholder="Enter your email"
              className="w-full border border-gray-300 px-4 py-2 mb-4 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
              value={email}
              onChange={(e) => setEmail(e.target.value)}
            />
            <button
